## DreamFactory Services Platform(tm) Core Server v1.8.0
...
This is the DreamFactory Services Platform&trade; Core Server repository. It contains the core web components necessary to run the system. It is available for use under the Apache Version 2.0 license.
