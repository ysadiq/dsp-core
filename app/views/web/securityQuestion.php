...
<div class="container" id="formbox">
	<h2>Password Reset Security Question</h2>
	...
	<?php else: ?>
		...
		<div class="form-group">
			...
			<div class="input-group">
				...
				<input tabindex="1" class="form-control password required" autofocus type="password" id="SecurityForm_answer" name="SecurityForm[answer]"
		...
		<div class="form-group">
			...
			<div class="input-group">
				...
				<input tabindex="2" class="form-control password required" type="password" id="SecurityForm_password" name="SecurityForm[password]"
		...
		<div class="form-group">
			...
			<div class="input-group">
				...
				<input tabindex="3" class="form-control password required" type="password" id="SecurityForm_passwordRepeat"
					   name="SecurityForm[passwordRepeat]"
