		...
		c.extend(
			PNotify.prototype,
			{
				...
				runModules:      function(b, a) {
					...
					for (e in this.modules) {
						if (c = "object" === typeof a && e in a ? a[e] : a, "function" === typeof this.modules[e][b]) {
							this.modules[e][b](
								this, "object" === typeof this.options[e] ? this.options[e] : {}, c
							)
						}
					}
				},
				...
				init:            function() {
					...
					!1 !==
					this.options.icon &&
					c("<div />", {"class": "ui-pnotify-icon"}).append(
						c(
							"<span />",
							{
								"class": !0 ===
					...
					!1 === this.options.text ? this.text_container.hide() : this.options.text_escape ? this.text_container.text(this.options.text) : this.text_container.html(
				...
				update:          function(b) {
					...
					a.shadow &&
					(
						this.options.shadow ? this.container.addClass("ui-pnotify-shadow") : this.container.removeClass("ui-pnotify-shadow")
					);
					!1 ===
					...
					this.options.title
						...
						: this.options.title !==
						  a.title &&
						  (
							  this.options.title_escape ? this.title_container.text(this.options.title) : this.title_container.html(this.options.title), !1 ===
																																						 a.title &&
					...
					this.options.text
						...
						: this.options.text !==
						  a.text &&
						  (
							  this.options.text_escape ? this.text_container.text(this.options.text) : this.text_container.html(
					...
					this.options.type !==
					a.type &&
					this.container.removeClass(this.styles.error + " " + this.styles.notice + " " + this.styles.success + " " + this.styles.info).addClass(
						"error" ===
						this.options.type
							? this.styles.error
							: "info" ===
					...
					if (this.options.icon !== a.icon || !0 === this.options.icon && this.options.type !== a.type) {
						this.container.find("div.ui-pnotify-icon").remove(), !1 !== this.options.icon && c(
				...
				parseOptions:    function(b, a) {
					...
					for (f in n) {
						...
						if ("object" !== typeof e) {
							...
							for (var d in e) {
								this.modules[d] ? c.extend(!0, this.options[d], e[d]) : this.options[d] = e[d]
							}
						}
					}
				},
				animateIn:       function(b) {
					...
					a
						...
						: "fade" ===
						  a
							  ? this.elem.show().fadeTo(this.options.animate_speed, this.options.opacity, b)
							  : "slide" ===
								a
							  ...
							  : "function" ===
								typeof a
									? a("in", b, this.elem)
									: this.elem.show(
						a, "object" === typeof this.options.animation.options_in ? this.options.animation.options_in : {}, this.options.animate_speed, b
					);
				...
				animateOut:      function(b) {
					...
					a
						...
						a,
						"object" ===
						typeof this.options.animation.options_out
				...
				position:        function(b) {
					...
					(
						c = this.elem.css({left: "0", top: "0", right: "0", bottom: "0"}).parent()
					);
					"undefined" ===
					typeof a.context &&
					(
					...
					if (a) {
						...
						if (!e || b) {
							...
							e ||
							(
								a.firstpos2 = f, a.nextpos2 = a.firstpos2
							);
							if ("down" === a.dir1 && a.nextpos1 + c.height() > (
									a.context.is(g) ? h.height() : a.context.prop("scrollHeight")
								) || "up" === a.dir1 && a.nextpos1 + c.height() > (
									a.context.is(g) ? h.height() : a.context.prop("scrollHeight")
								) || "left" === a.dir1 && a.nextpos1 + c.width() > (
									a.context.is(g) ? h.width() : a.context.prop("scrollWidth")
								) || "right" === a.dir1 && a.nextpos1 + c.width() > (
									a.context.is(g) ? h.width() : a.context.prop("scrollWidth")
								)) {
								a.nextpos1 = a.firstpos1, a.nextpos2 += a.addpos2 + (
									"undefined" === typeof a.spacing2 ? 25 : a.spacing2
								), a.addpos2 = 0;
							}
							if (a.animation && a.nextpos2 < f) {
								switch (a.dir2) {
									case "down":
										d.top = a.nextpos2 + "px";
										break;
							...
							) && c.animate(d, {duration: this.options.position_animate_speed, queue: !1});
							switch (a.dir1) {
								case "down":
								case "up":
									a.nextpos1 +=
				...
				cancelRemove:    function() {
					...
					this.state &&
					(
						this.elem.stop(!0), this.state = "open", this.animating = "in", this.elem.css("height", "auto").animate(
							{
				...
				notices:        [], removeAll: function() {
					...
					c.each(
						PNotify.notices, function() {
							...
							a &&
							(
								a.nextpos1 = a.firstpos1, a.nextpos2 = a.firstpos2, a.addpos2 = 0, a.animation = b
							)
						}
					);
					c.each(
	...
	function(c, e) {
		...
		e.prototype.modules.buttons = {
			myOptions: null, closer: null, sticker: null, init: function(a, b) {
				...
				a.elem.on(
					{
						mouseenter:    function(b) {
							!d.myOptions.sticker || a.options.nonblock && a.options.nonblock.nonblock || d.sticker.trigger("pnotify_icon").css(
								"visibility", "visible"
							);
				...
				(
				!b.sticker || a.options.nonblock && a.options.nonblock.nonblock
				...
				(
				!b.closer || a.options.nonblock && a.options.nonblock.nonblock
				...
				!b.sticker || a.options.nonblock && a.options.nonblock.nonblock ? this.sticker.css(
					"display", "none"
	...
	function(e, d) {
		...
		d.prototype.modules.desktop = {
			tag:            null, icon: null, genNotice: function(a, b) {
				...
				b.desktop &&
				(
					c = d.desktop.checkPermission(), 0 == c && this.genNotice(a, b)
				)
				...
				b.desktop &&
				(
					a.elem.css({left: "-10000px", display: "none"}), "show"in a.desktop && a.desktop.show()
				)
				...
				b.desktop &&
				(
					a.elem.css({left: "-10000px", display: "none"}), a.desktop.close()
				)
			}
		};
		d.desktop = {
