...
(
	function() {
		...
		templates['content_type'] = template(function(Handlebars, depth0, helpers, partials, data) {
			...
			stack1 =
				helpers['if'].call(depth0, depth0.produces,
								   {hash: {}, inverse: self.program(4, program4, data), fn: self.program(1, program1, data), data: data});
			if (stack1 || stack1 === 0) {
				buffer += stack1;
			}
			buffer += "\n</select>\n";
				...
				buffer += "<div class=\"info_tos\"><a href=\"" + escapeExpression((
																					  (
																						  stack1 = (
																							  (
																								  stack1 = depth0.info
																								  ), stack1 == null || stack1 === false ? stack1
			...
			function program4(depth0, data) {
				...
				buffer += "<div class='info_contact'><a href=\"mailto:" + escapeExpression((
																							   (
																								   ...
																								   ), typeof stack1 === functionType ? stack1.apply(depth0)
																								   : stack1
	...
	function() {
		...
		templates['operation'] = template(function(Handlebars, depth0, helpers, partials, data) {
			...
			function program1(depth0, data) {
				...
				if (helpers.event_type || depth0.event_name) {
			...
			buffer += "\n          ";
			stack1 =
				helpers['if'].call(depth0, depth0.isReadOnly,
	...
	function() {
		...
		templates['param'] = template(function(Handlebars, depth0, helpers, partials, data) {
			...
			function program1(depth0, data) {
				...
				buffer += "\n		";
				stack1 =
					helpers['if'].call(depth0, depth0.isFile,
									   {hash: {}, inverse: self.program(4, program4, data), fn: self.program(2, program2, data), data: data});
				if (stack1 || stack1 === 0) {
					buffer += stack1;
				}
				buffer += "\n	";
			...
			function program4(depth0, data) {
				...
				buffer += "\n			";
				stack1 =
					helpers['if'].call(depth0, depth0.defaultValue,
			...
			stack1 =
				helpers['if'].call(depth0, depth0.isBody,
								   {hash: {}, inverse: self.program(9, program9, data), fn: self.program(1, program1, data), data: data});
			if (stack1 || stack1 === 0) {
				buffer += stack1;
			}
			buffer += "\n\n</td>\n<td>";
	...
	function() {
		...
		templates['param_list'] = template(function(Handlebars, depth0, helpers, partials, data) {
			...
			function program8(depth0, data) {
				...
				buffer += "\n      ";
				stack1 =
					helpers['if'].call(depth0, depth0.isDefault,
									   {hash: {}, inverse: self.program(11, program11, data), fn: self.program(9, program9, data), data: data});
				if (stack1 || stack1 === 0) {
					buffer += stack1;
				}
			...
			buffer += escapeExpression(stack1) + "'>\n    ";
			stack1 =
				helpers['if'].call(depth0, depth0.required,
...
(
	function() {
		...
		templates['parameter_content_type'] = template(function(Handlebars, depth0, helpers, partials, data) {
			...
			stack1 =
				helpers['if'].call(depth0, depth0.consumes,
								   {hash: {}, inverse: self.program(4, program4, data), fn: self.program(1, program1, data), data: data});
			if (stack1 || stack1 === 0) {
				buffer += stack1;
			}
			...
			(
				function(_super) {
					...
					OperationView.prototype.toggleOperationContent = function() {
						var elem;
						elem =
							$('#' + Docs.escapeResourceName(this.model.resourceName) + "_" + this.model.nickname + "_" + this.model.method + "_" +
								  this.model.number + "_content");
						if (elem.is(':visible')) {
